var ExercisePython = function (aData, sExercise){
    ...
    this.loadLevel = function() {
        ...
        this.resetGUI();
        //$("#start").on("click");
        this.oExecuter = new ExecuterPython(this.aData.tests, this.aData.context);
    ...
    this.resetGUI =function () {
        ...
        $("title").text("Active Python : " + this.aData.info.name);
        $("h1").text("Active Python : " + this.aData.info.name);
