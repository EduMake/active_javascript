...
var Decrypt = function(PlainAlphabet, CypherAlphabet, CypherText) {
    ...
    while(Position < CypherText.length ) { 
        var CypherTextLetter = CypherText[Position]; //The letter we want to EnPlain this time
        var LetterNum = CypherAlphabet.search(PlainTextLetter); //Finds what position our Letter is in our Alphabet
